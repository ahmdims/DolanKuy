...
@section('content')
    ...
    <link href="{{ asset('css/vendor/trix.min.css') }}" rel="stylesheet">
    <script src="{{ asset('js/vendor/trix.min.js') }}" defer></script>
                ...
                <table class="data-table data-table-pagination data-table-standard responsive nowrap stripe"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="text-muted text-small text-uppercase">Nama UMKM</th>
                    ...
                    <tbody>
                        ...
                        @foreach ($msme as $msme_data)
                            <tr>
                                ...
                                <td>
                                    <a data-bs-toggle="modal" data-bs-target="#imagesModal-{{ $msme_data->id }}"
                                ...
                                <td>
                                    <div class="d-flex align-items-center" style="height: 100%;">
                                        ...
                                        <a data-bs-toggle="modal" data-bs-target="#formModal" type="button"
                                            data-id="{{ $msme_data->id }}"
                                            class="btn-edit btn btn-icon btn-icon-only btn-warning mb-1 me-1"
                                            title="Update">
...
<script src="{{ asset('js/admin/msme.js') }}"></script>
