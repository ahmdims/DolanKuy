<div class="modal fade modal-close-out" id="detailModal-{{ $destination_data->id }}" tabindex="-1" role="dialog" aria-labelledby="Modal" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <div type="text" class="form-control" name="description" id="quillDescription" readonly>{!! $destination_data->description !!}"</div>
                </div>

                <div class="mb-3">
                    <label for="address" class="form-label">Alamat</label>
                    <input type="text" class="form-control" name="address" value="{{ $destination_data->address }}" readonly>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="province" value="{{ $destination_data->province }}" readonly>
                </div>
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label for="latitude" class="form-label">Latitude</label>
                        <input type="text" class="form-control" name="latitude" value="{{ $destination_data->latitude }}" readonly>
                    </div>
                    <div class="col-md-6">
                        <label for="longitude" class="form-label">Longitude</label>
                        <input type="text" class="form-control" name="longitude" value="{{ $destination_data->longitude }}" readonly>
                    </div>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="time" class="form-control" name="opening_time" value="{{ $destination_data->opening_time }}" readonly>
                </div>
                <div class="mb-3">
                    <label for="closing_time" class="form-label">Jam Tutup</label>
                    <input type="time" class="form-control" name="closing_time" value="{{ $destination_data->closing_time }}" readonly>
                </div>
                <div class="mb-3">
                    <label for="ticket_price" class="form-label">Harga Tiket</label>
                    <input type="text" class="form-control" name="ticket_price" value="{{ $destination_data->ticket_price }}" readonly>
                </div>
                <div class="mb-3">
                    <label for="facilities" class="form-label">Fasilitas</label>
                    <input type="text" class="form-control" name="facilities" value="{{ $destination_data->facilities }}" readonly>
                </div>
                <div class="mb-3">
                    <label for="contact" class="form-label">Kontak</label>
                    <input type="text" class="form-control" name="contact" value="{{ $destination_data->contact }}" readonly>
                </div>
            </div>
