<div class="modal fade modal-close-out" id="imagesModal-{{ $destination_data->id }}" tabindex="-1" role="dialog"
    aria-labelledby="Modal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="Modal">Gambar {{ $destination_data->name }}</h5>
                        ...
                        @if($destination_data->images->isNotEmpty())
                            <div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    @foreach($destination_data->images as $index => $image)
