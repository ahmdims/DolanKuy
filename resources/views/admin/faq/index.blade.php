                            ...
                            <td>
                                <div class="d-flex align-items-center" style="height: 100%;">
                                    ...
                                    <a data-bs-toggle="modal" data-bs-target="#updateModal-{{ $faq_data->id }}"
                                        type="button" class="btn btn-icon btn-icon-only btn-warning me-1" title="Update">
...
<script>
    ...
    document.getElementById('createFaqForm').addEventListener('submit', function (event) {
