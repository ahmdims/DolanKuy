        ...
        <div class="card-body">
          <div class="table-responsive-sm mb-5">
            <table class="table" id="userTable">
              ...
              <tbody>
                @foreach($destinasi_wisata as $destinasi_data)
          <tr>
            <td class="text-center">{{ $loop->iteration }}.</td>
            <td class="text-center">{{ $destinasi_data->email }}</td>
            <td class="text-center">{{ $destinasi_data->username }}</td>
            <td class="text-center">{{ $destinasi_data->name }}</td>
            <td class="text-center">{{ $destinasi_data->role }}</td>
