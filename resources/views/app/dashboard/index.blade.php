...
<div class="container">
                        ...
                        <div class="row g-0 h-100 chart-container">
                            ...
                            <div
                                ...
                                <div>
                                    <div>
                                        <div
                                            class="cta-2 text-primary value d-inline-block align-middle sw-4">
                                        </div>
                                ...
                                <div class="glide__slide">
                                    <div class="card mb-5 sh-20 hover-border-primary">
                                        <div
                                            ...
                                            <div
                                                class="d-flex flex-column justify-content-center align-items-center sh-5 sw-5 rounded-xl bg-gradient-light mb-2">
                                                <i data-acorn-icon="navigate-diagonal"
                                                    class="text-white"></i>
                                            </div>
                                ...
                                <div class="glide__slide">
                                    <div class="card mb-5 sh-20 hover-border-primary">
                                        <div
                                            ...
                                            <div
                                                class="d-flex flex-column justify-content-center align-items-center sh-5 sw-5 rounded-xl bg-gradient-light mb-2">
                                                <i data-acorn-icon="arrow-bottom-left"
                                                    class="text-white"></i>
                                            </div>
                ...
                <div class="scroll-by-count" data-count="6">
                                ...
                                <div class="card-body pt-0 pb-0 h-100">
                                    <div class="row g-0 h-100 align-content-center">
                                        <div class="col-12 col-md-7 d-flex flex-column mb-2 mb-md-0">
                                            ...
                                            <div class="text-small text-muted text-truncate">Marshmallow
                                                topping icing liquorice oat
                                                cake.</div>
                                        </div>
                                        <div
                                            class="col-12 col-md-5 d-flex align-items-center justify-content-md-end">
                                ...
                                <div class="card-body pt-0 pb-0 h-100">
                                    <div class="row g-0 h-100 align-content-center">
                                        <div class="col-12 col-md-7 d-flex flex-column mb-2 mb-md-0">
                                            ...
                                            <div class="text-small text-muted text-truncate">Tootsie brownie
                    ...
                    <div class="card mb-2">
                        <div class="row g-0 sh-12">
                            <div class="col-auto">
                                <a href="Pages.Portfolio.Detail.html">
                                    <img src="img/product/small/product-5.webp" alt="alternate text"
                                        class="card-img card-img-horizontal sw-13 sw-lg-15" />
                                </a>
                            </div>
                            <div class="col">
                                <div class="card-body pt-0 pb-0 h-100">
                                    <div class="row g-0 h-100 align-content-center">
                                        <div class="col-12 col-md-7 d-flex flex-column mb-2 mb-md-0">
                                            ...
                                            <div class="text-small text-muted text-truncate">Tootsie roll
                                                cream marshmallow chocolate
                                                bar.</div>
                                        </div>
                                        <div
                                            class="col-12 col-md-5 d-flex align-items-center justify-content-md-end">
                    ...
                    <div class="card mb-2">
                        <div class="row g-0 sh-12">
                            <div class="col-auto">
                                <a href="Pages.Portfolio.Detail.html">
                                    <img src="img/product/small/product-6.webp" alt="alternate text"
                                        class="card-img card-img-horizontal sw-13 sw-lg-15" />
                                </a>
                            </div>
                            <div class="col">
                    ...
                    <div class="card mb-2">
                        <div class="row g-0 sh-12">
                            <div class="col-auto">
                                <a href="Pages.Portfolio.Detail.html">
                                    <img src="img/product/small/product-7.webp" alt="alternate text"
                                        class="card-img card-img-horizontal sw-13 sw-lg-15" />
                                </a>
                            </div>
                            <div class="col">
    ...
    <div class="row">
                            ...
                            <div class="col">
                                <div
                                    ...
                                    <div class="d-flex flex-column">
                                        <div class="text-alternate mt-n1 lh-1-25">New user registiration
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row g-0 mb-2">
                            ...
                            <div class="col">
                                <div
                                    class="card-body d-flex flex-column pt-0 pb-0 ps-3 pe-4 h-100 justify-content-center">
                                    <div class="d-flex flex-column">
                                        <div class="text-alternate mt-n1 lh-1-25">Category page returned an
                                            error</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row g-0 mb-2">
                            ...
                            <div class="col">
                                <div
                                    class="card-body d-flex flex-column pt-0 pb-0 ps-3 pe-4 h-100 justify-content-center">
                                    <div class="d-flex flex-column">
                                        <div class="text-alternate mt-n1 lh-1-25">Recived a support ticket
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="col-lg-6 mb-5">
            ...
            <div class="row g-2">
                <div class="col-6 col-xl-4 sh-19" data-title="More Cards"
                    data-intro="Category card with an icon!" data-step="3">
        ...
        <div class="col-12 col-xl-4">
            ...
            <div class="card h-100-card">
                <div class="card-body">
                    ...
                    <div class="text-muted mb-4">Cheesecake chocolate carrot cake pie drops. Brownie ice
                        cream marshmallow
                        topping.</div>
                    <form>
