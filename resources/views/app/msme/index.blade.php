...
<div class="container">
    <div class="col-12">
        <div class="card w-100 mb-5 position-relative">
            <img src="{{ asset('img/banner/dolankuy-2.png') }}" class="card-img img-fluid w-100 h-auto" alt="card image"
            ...
            <div class="card-img-overlay d-flex flex-column justify-content-center align-items-start bg-transparent">
                <div class="row">
                    <h3 class="font-weight-bold text-white">UMKM</h3>
                    <p class="card-text text-white">Temukan berbagai UMKM khas Malang yang super menarik di DolanKuy!!
                    </p>
                </div>
            </div>
        </div>
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            <h5 class="heading mb-3">
                                <a href="{{ route('app.msme.detail', $msme_data->slug) }}" class="body-link stretched-link">
                            ...
                            <div>
                                <div class="row g-0">
                                    ...
                                    <div class="col-auto pe-3">
                                        ...
                                        <span class="align-middle">{{ $msme_data->comments_count }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
