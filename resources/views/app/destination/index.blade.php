...
<div class="container">
    <div class="col-12">
        <div class="card w-100 mb-5 position-relative">
            <img src="{{ asset('img/banner/dolankuy-1.png') }}" class="card-img img-fluid w-100 h-auto" alt="card image"
            ...
            <div class="card-img-overlay d-flex flex-column justify-content-center align-items-start bg-transparent">
                <div class="row">
                    <h3 class="font-weight-bold text-white">Destinasi Wisata</h3>
                    <p class="card-text text-white">Cek Beragam Destinasi Keren di Malang yang Lagi Hits di DolanKuy, sobat!
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="isotope-container row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-xl-4 gx-4 gy-4">
                ...
                <div class="col mb-4 isotope-item">
                    <div class="card h-100">
                        ...
                        @php
                        $firstImage = $destination_data->images->first();
                        @endphp
                        ...
                        <div class="card-body">
                            <h5 class="heading mb-3">
                                <a href="{{ route('app.destination.detail', $destination_data->slug) }}" class="body-link stretched-link">
                                    <span class="clamp-line sh-5" data-line="2">{{ $destination_data->name }}</span>
                                </a>
                            </h5>
                            <div>
                                <div class="row g-0">
                                    <div class="col-auto pe-3">
                                        ...
                                        <span class="align-middle">{{ $destination_data->viewCount() }}</span>
                                    </div>
                                    <div class="col-auto pe-3">
                                        <i data-acorn-icon="like" class="text-primary me-0" data-acorn-size="20"></i>
                                        <span class="align-middle">{{ $destination_data->likeCount() }}</span>
                                    </div>
                                    <div class="col-auto pe-3">
