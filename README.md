...
```bash
git clone https://github.com/dimas551/DolanKuy.git
cd DolanKuy
```
...
Your DolanKuy application should now be up and running. You can access it at `http://127.0.0.1:8000`.
