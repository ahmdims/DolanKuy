					...
					value: function () {
						(this.prototype.Emitter = Emitter),
							...
							(this.prototype.defaultOptions = {
								...
								renameFile: null,
								forceFallback: !1,
								dictDefaultMessage: "Letakkan file di sini untuk diunggah",
								dictFallbackMessage:
									"Browser Anda tidak mendukung pengunggahan file drag'n'drop.",
								dictFallbackText:
									"Silakan gunakan formulir cadangan di bawah ini untuk mengunggah file Anda seperti dulu.",
								dictFileTooBig:
									"File terlalu besar ({{filesize}}MiB). Ukuran file maksimal: {{maxFilesize}}MiB.",
								dictInvalidFileType:
									"Anda tidak dapat mengunggah file jenis ini.",
								dictResponseError:
									"Server merespons dengan kode {{statusCode}}.",
								dictCancelUpload: "Batalkan unggahan",
								dictUploadCanceled: "Pengunggahan dibatalkan.",
								dictCancelUploadConfirmation:
									"Apakah Anda yakin ingin membatalkan unggahan ini?",
